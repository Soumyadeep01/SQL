...
public class banksystem {
	...
	public static void main(String args[]) throws IOException {
		...
		try {
			...
			String conurl = "jdbc:sqlserver://172.17.144.108;databaseName=S1941012805";
			con = DriverManager.getConnection(conurl, "S1941012805", "Iter1234#");
			...
			do {
				...
				case 2:
					...
					System.out.print("Enter the Customer id(Must start with C): ");
					String id = Sc.next();
